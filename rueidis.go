...
type ClientOption struct {
	...
	// produce notable CPU usage reduction under load. Ref: https://github.com/diaz-jared/rueidis/issues/156
	...
	// But if you have large requests or fast network, this might degrade the performance. Ref: https://github.com/diaz-jared/rueidis/pull/650
